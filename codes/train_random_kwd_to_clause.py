...
def collate_rnd_kwd_to_clause(batch, tokenizer, input_max_length, output_max_length):
...
if __name__ == '__main__':
    ...
    collate_fn = partial(collate_rnd_kwd_to_clause, tokenizer=tokenizer, 
