...
if __name__ == '__main__':
    ...
    N_EPOCHS = 15
    LOG_STEPS = 200
    VALIDATE_PER_EPOCH = 0.25
    DEV_BLEU_EVERY_K_RANDOM_STEPS = 10
    EXP_NAME = 'kwd-to-clause-bart-base'
    ...
    # PREV_EXP_PATH = 'kwd-to-clause-bart/best.pth'
    ...
    # save_dict = torch.load(PREV_EXP_PATH)
    ...
    # scheduler = get_constant_schedule(optimizer, **SCHEDULER_ARGS)
